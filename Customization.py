...
# Basic options
parser.add_argument("-style_image", help="Style target image", default='./Dataset/Disney')
parser.add_argument("-style_blend_weights", default=None)
parser.add_argument("-content_image", help="Content target image", default='./Dataset/Celebrity')
...
parser.add_argument("-lbfgs_num_correction", type=int, default=10)
...
def main(dir_content, dir_style):
    ...
    style_image_input = dir_style.split(',')
    ...
    def maybe_save(t,dir_content, dir_style):
        ...
        if should_save:
            ...
            if t == params.num_iterations:
                ...
                filename = params.output_image+ '/' + dir_content + "_" + dir_style +"_"+ str(t) + '.png'
            else:
                filename = params.output_image+ '/' + dir_content + "_" + dir_style +"_"+ str(t) + '.png'
    ...
    def feval():
        ...
        maybe_save(num_calls[0],content_name,style_name)
...
def list_images(dir):
    ...
    for i in range(len(img_names)):
        img_name= os.path.join(dir,img_names[i])
        img_list.append(img_name)
    return img_list


if __name__ == "__main__":
    list_content = list_images(params.content_image)
    list_style = list_images(params.style_image)

    for i in range(len(list_content)):
        for j in range(len(list_style)):
            main(list_content[i],list_style[j])
